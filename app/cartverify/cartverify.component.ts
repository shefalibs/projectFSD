...
export class CartverifyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let url=`http://b8java03.iiht.tech:3000/findcustomerid/`+this.cid;
    fetch(url)
    .then(res=>res.json())
    .then(data=>{
      console.log(data)
    ...
    setTimeout(()=>{
    let url4="http://b8java03.iiht.tech:3000/seecart?cid="+this.cid;
    fetch(url4,{
     method:"GET",
     headers:{
       "content-type":"application/json"
  ...
  pay(){
    ...
    let url="http://b8java03.iiht.tech:3000/setidproof?idnum="+this.myid+"&cid="+this.cid;
    fetch(url,{
      method:"GET",
      headers:{
        "content-type":"application/json"
    ...
    return this.http.post<any>('http://b8java03.iiht.tech:3000/payment-details', paymentPayload).subscribe(
      data => {
      console.log(data)
  ...
  transaction(){
    let url="http://b8java03.iiht.tech:3000/walletpayment?cid="+this.cid+"&amount="+this.amount;
    fetch(url).then(res=>res.json())
    .then(data=>{
      console.log(data[0]);
      if(data[0]=="success"){
        let url="http://b8java03.iiht.tech:3000/checkout?cid="+this.cid+"&status=success";
      fetch(url)
      .then(res=>res.json())
      .then(data=>{
        console.log(data)
      ...
      setTimeout(()=>{
        ...
        let url3="http://b8java03.iiht.tech:3000/sendinvoice";
        fetch(url3,{
          method:"POST",
          headers:{
            "content-type":"application/json"
